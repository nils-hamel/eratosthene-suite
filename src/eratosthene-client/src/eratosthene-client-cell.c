 ...
 */
    ...
    le_void_t er_cell_get_shell( er_cell_t * const er_cell, le_real_t const er_lon, le_real_t const er_lat ) {
        ...
        le_real_t er_vera[3] = { 0.0 };
        le_real_t er_verb[3] = { 0.0 };

        le_real_t er_span = LE_ADDRESS_RAN_L / pow( 2.0, er_cell->ce_addr.as_size );

        le_real_t er_hfact = er_span * ( LE_ADDRESS_WGS_A );
        //le_real_t er_hfact = ( LE_ADDRESS_RAN_H / pow( 2.0, er_cell->ce_addr.as_size - 10 ) );

        le_address_get_pose( & er_cell->ce_addr, er_edge );
        ...
        glBegin( GL_LINES );
            ...
            er_verb[0] = er_edge[0] + er_span;
            er_verb[1] = er_edge[1];
            er_verb[2] = er_edge[2];

            er_geodesy_cartesian( er_vera );
            er_geodesy_cartesian( er_verb );

            glVertex3f( er_vera[0], er_vera[1], er_vera[2] );
            glVertex3f( er_verb[0], er_verb[1], er_verb[2] );
            ...
            er_vera[0] = er_edge[0];
            er_vera[1] = er_edge[1];
            er_vera[2] = er_edge[2] + er_hfact;

            er_verb[0] = er_edge[0] + er_span;
            er_verb[1] = er_edge[1];
            er_verb[2] = er_edge[2] + er_hfact;
